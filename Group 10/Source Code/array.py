...
frame3 = Frame(root)
frame4 = LabelFrame(root, bg="black")
...
def option_insert(*args):
    ...
    b6 = Button(frame5, text="With Index", font=font, bg="black", fg="white", relief=FLAT,
                borderwidth=3, padx=50, activebackground="black", activeforeground="white")
    b6.pack(pady=10)
    b6.bind("<Return>", In)
    b6.bind("<Button-1>", In)

    b8 = Button(frame5, text="With Value", font=font, bg="white", fg="black", relief=FLAT,
                borderwidth=3, padx=50, activebackground="white", activeforeground="white")
    b8.pack(pady=10)
    b8.bind("<Return>", add)
    b8.bind("<Button-1>", add)

    b11 = Button(frame5, text="Back", font=font, bg="white", fg="black", relief=FLAT,
                 borderwidth=3, padx=50, activebackground="white", activeforeground="black")
    b11.pack(pady=10)
...
def button():
    ...
    Add_button = Button(frame4, text="Insert", font=font2, borderwidth=3, bg="white",
                        fg="black", relief=FLAT, activebackground="white", activeforeground="black")
    Add_button.grid(row=0, column=0, padx=3, pady=5)
    Add_button.bind("<Return>", option_insert)
    Add_button.bind("<Button-1>", option_insert)

    Search_button = Button(frame4, text="Search", font=font2, borderwidth=3, bg="white",
                           fg="black", relief=FLAT, activebackground="black", activeforeground="black")
    Search_button.grid(row=0, column=1, padx=3, pady=5)
    Search_button.bind("<Return>", V_search)
    Search_button.bind("<Button-1>", V_search)

    Delete_button = Button(frame4, text="Delete", font=font2, borderwidth=3, bg="white",
                           fg="black", relief=FLAT, activebackground="white", activeforeground="black")
    Delete_button.grid(row=0, column=2, pady=5, padx=3)
    Delete_button.bind("<Return>", option_D)
    Delete_button.bind("<Button-1>", option_D)

    Back_button = Button(frame4, text="Back", font=font2, borderwidth=3, bg="white",
                         fg="black", relief=FLAT, activebackground="white", activeforeground="black")
    Back_button.grid(row=0, column=3, pady=5, padx=3)
...
def tab3(*args):
    ...
    frame2 = LabelFrame(root, bg="black", bd=5)
...
def tab2(*args):
    ...
    en2 = Entry(frame3, bg="white", font=font, borderwidth=3)
    en2.grid(row=3, column=4, columnspan=2, pady=10)

    b4 = Button(frame3, text="Create", font=font, borderwidth=3, bg="white",
                fg="black", relief=FLAT, activebackground="white", activeforeground="black")
    b4.grid(row=5, column=0, columnspan=8, pady=15)
    b4.bind("<Return>", tab3)
    b4.bind("<Button-1>", tab3)

    b5 = Button(frame3, text="Back", font=font, borderwidth=3, bg="white", fg="black",
                relief=FLAT, activebackground="white", activeforeground="black", padx=13)
...
def tab1(*args):
    ...
    b1 = Button(frame1, text="Array", font=font, bg="white", fg="black", relief=FLAT,
                borderwidth=3, padx=50, activebackground="white", activeforeground="black")
    b1.pack(pady=10)
    b1.bind("<Return>", tab2)
    b1.bind("<Button-1>", tab2)

    b2 = Button(frame1, text="Linked List", font=font, bg="white", fg="black", relief=FLAT,
                borderwidth=3, padx=15, activebackground="white", activeforeground="black", command=linklist)
    b2.pack(pady=10, padx=10)

    b3 = Button(frame1, text="EXIT", font=font, bg="white", fg="black", relief=FLAT,
                borderwidth=3, padx=58, activebackground="white", activeforeground="black")
...
def In(*args):
    ...
    en4 = Entry(frame7, font=font, bg="white", width=5, borderwidth=3)
    ...
    b10 = Button(frame7, text="Update", font=font, bg="white", fg="black", relief=FLAT,
                 borderwidth=3, padx=50, activebackground="white", activeforeground="black")
    b10.grid(row=2, column=0, columnspan=2, pady=5)
    b10.bind("<Return>", out)
    b10.bind("<Button-1>", out)

    b11 = Button(frame7, text="Back", font=font, bg="white", fg="black", relief=FLAT,
                 borderwidth=3, padx=50, activebackground="white", activeforeground="black")
...
def show_V(*args):
    ...
    frame2.destroy()
    frame2 = LabelFrame(root, bg="black")
    frame2.pack(pady=20)
...
def option_D(*args):
    ...
    b15 = Button(frame10, text="With Index", font=font, bg="white", fg="black", relief=FLAT,
                 borderwidth=3, padx=50, activebackground="white", activeforeground="black")
    b15.pack(pady=10)
    b15.bind("<Return>", Delete_I)
    b15.bind("<Button-1>", Delete_I)

    b16 = Button(frame10, text="With Value", font=font, bg="white", fg="black", relief=FLAT,
                 borderwidth=3, padx=50, activebackground="white", activeforeground="black")
    b16.pack(pady=10)
    b16.bind("<Return>", Delete_V)
    b16.bind("<Button-1>", Delete_V)

    b17 = Button(frame10, text="Back", font=font, bg="white", fg="black", relief=FLAT,
                 borderwidth=3, padx=50, activebackground="white", activeforeground="black")
    b17.pack(pady=10)
...
def Delete_I(*args):
    ...
    en8 = Entry(frame11, width=5, font=font, bg="white", borderwidth=5)
    en8.grid(row=0, column=1)

    b18 = Button(frame11, text="Enter", font=font2, bg="white", fg="black", relief=FLAT,
                 borderwidth=3, padx=50, activebackground="white", activeforeground="black")
    b18.grid(row=2, column=0, columnspan=5, pady=20)
    b18.bind("<Return>", Delete_IR)
    b18.bind("<Button-1>", Delete_IR)

    b19 = Button(frame11, text="Back", font=font2, bg="white", fg="black", relief=FLAT,
                 borderwidth=3, padx=50, activebackground="white", activeforeground="black")
...
def Delete_V(*args):
    ...
    en7 = Entry(frame9, width=5, font=font, borderwidth=5, bg="white")
    en7.grid(row=0, column=1)

    b14 = Button(frame9, text="Enter", font=font, bg="white", fg="black", relief=FLAT,
                 borderwidth=3, padx=50, activebackground="white", activeforeground="black")
    b14.grid(row=2, column=0, columnspan=5, pady=20)
    b14.bind("<Return>", Delete_VR)
    b14.bind("<Button-1>", Delete_VR)

    b15 = Button(frame9, text="Back", font=font, bg="white", fg="black", relief=FLAT,
                 borderwidth=3, padx=50, activebackground="white", activeforeground="black")
...
def Delete_VR(*args):
    ...
    global frame2
    frame2.destroy()
    frame2 = Label(root, bg="black", borderwidth=3)
    frame2.pack(pady=20)
...
def add(*args):
    ...
    en3 = Entry(frame6, font=font, bg="white", borderwidth=3)
    en3.pack()

    b7 = Button(frame6, text="Update", font=font, bg="white", fg="black", relief=FLAT,
                borderwidth=3, padx=50, activebackground="white", activeforeground="black")
    b7.pack(pady=10)
    b7.bind("<Return>", show_V)
    b7.bind("<Button-1>", show_V)

    b9 = Button(frame6, text="Back", font=font, bg="white", fg="black", relief=FLAT,
                borderwidth=3, padx=50, activebackground="white", activeforeground="black")
    b9.pack(pady=10)
...
def V_search(*args):
    ...
    en6 = Entry(frame8, font=font, bg="white", borderwidth=3)
    en6.pack(pady=20)

    b12 = Button(frame8, text="Update", font=font, bg="white", fg="black", relief=FLAT,
                 borderwidth=3, padx=50, activebackground="white", activeforeground="black")
    b12.pack(pady=20)
    b12.bind("<Return>", V_search_result)
    b12.bind("<Button-1>", V_search_result)

    b13 = Button(frame8, text="Back", font=font, bg="white", fg="black", relief=FLAT,
                 borderwidth=3, padx=50, activebackground="white", activeforeground="black")
    b13.pack(pady=10)
