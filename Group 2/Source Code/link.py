...
class LinkList: # One and only class of that project
    def __init__(self,root):
        ...
        #Make the Canvas
        self.canvas_make = Canvas(self.window,bg="azure4",width=1350,height=500,relief=RAISED, bd=8)
    ...
    def heading_with_label_subheading(self):
        self.head_name = Label(self.window, text=" Link List  ", font=("Arial", 60,"bold","italic"),
                               bg="azure4", fg="yellow")
    ...
    def make_start_with_other(self):
        ...
        self.start_label = Label(self.canvas_make,text="start",font=("Arial",20,"bold"),bg="chocolate",
                                 fg="#00FF00")
